...
As far as tested, when Q matrix has different _relative_ diagonal weights between LQR and IOC approaches, the results of LQR and IOC are totally different. Tests on Q matrix _relative_ diagonal weights are _not_ reported here.

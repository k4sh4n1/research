...
# =============================================================================
def calculate_tmd_params(mass_ratio=0.01):
...
# =============================================================================
def main():
    # Calculate TMD parameters (mass ratio = 0.01)
    m_d, k_d, c_d, M1, omega1 = calculate_tmd_params(mass_ratio=0.01)

    print("=" * 60)
    print("TMD PARAMETERS (m_d = 0.01 * M1)")
    print("=" * 60)
    ...
    plt.suptitle(
        "Seismic Response Comparison: Original vs TMD-Equipped (m_d = 0.01·M₁)",
        fontsize=13,
        fontweight="bold",
    )
    plt.tight_layout()
    plt.savefig("task3_response_comparison.png", dpi=150)
    plt.show()
